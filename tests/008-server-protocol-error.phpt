--TEST--
WebSocket\Server closes protocol errors with close code 1002
--EXTENSIONS--
websocket
--SKIPIF--
<?php
...
$tmpDir = sys_get_temp_dir() . '/websocket-server-protocol-error-test-' . getmypid();
...
if ($client !== false) {
    ...
    fwrite($client, Protocol::pack('unmasked', Protocol::OPCODE_TEXT, Protocol::FLAG_FIN));
